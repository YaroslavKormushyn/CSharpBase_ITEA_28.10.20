...
namespace MaxOfThreeIntegers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (x > y && x > z && x > k && x > l)
            {
                Console.WriteLine("The biggest of three integers is " + x);
            }
            else if (y > x && y > z && y > k && y > l)
            {
                Console.WriteLine("The biggest of three integers is " + y);
            }
            else if (z > x && z > y && z > k && z > l)
            {
                Console.WriteLine("The biggest of three integers is " + z);
            }
            else if (k > x && k > z && k > y && k > l)
            {
                Console.WriteLine("The biggest of three integers is " + k);
            }
            else if (l > x && l > y && l > k && l > z)
            {
                Console.WriteLine("The biggest of three integers is " + l);
            }
            else
            {
                Console.WriteLine("Five digits are equal");
            }
            /* int[] array = new int[5];
             Console.WriteLine("Enter the first digit: ");
